<template>
  <div class="page">
    ...
    <el-table :data="rows" stripe>
      <el-table-column prop="profile.full_name" :label="$t('tables.teacher')" />
      ...
      <el-table-column prop="teacher_status" :label="$t('tables.status')">
        <template #default="scope">
          <el-select v-model="scope.row.teacher_status" size="small" @change="(v) => changeStatus(scope.row.id, v)">
